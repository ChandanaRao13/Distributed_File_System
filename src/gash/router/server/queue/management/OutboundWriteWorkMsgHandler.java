...
public class OutboundWriteWorkMsgHandler extends Thread {
	private QueueManager manager;
	protected static Logger logger = LoggerFactory.getLogger(OutboundWriteWorkMsgHandler.class);

	public OutboundWriteWorkMsgHandler(QueueManager manager) {
		super();
		this.manager = manager;
		if (manager.outboundWriteWorkQueue == null)
	...
	public void run() {
		while (true) {
			try {
				InternalChannelNode message = manager.dequeueOutboundWriteWork();
