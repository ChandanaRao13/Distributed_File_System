...
public class RaftMessageBuilder {
	...
	/**
	 * /* Builds the Message in order to request vote to all other nodes during
	 * election process
	 * 
	 * @param currentTerm
	 * @return
	...
	/**
	 * /* Builds the Message in order to send Leader's heart beat to all other
	 * nodes
	 * 
	 * @param leaderId
	 * @param currentTerm
	...
	/**
	 * Builds the Message in order to send acknowledgement from Follower to
	 * Leader
	 * 
	 * @param leaderId
	 * @param currentTerm
